...
export default function LearningPage() {
  ...
  const completedLessons = 0 // TODO: from progress API
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    <div className="relative w-12 h-12 flex-shrink-0">
                      <svg className="w-12 h-12 -rotate-90" viewBox="0 0 36 36">
                        ...
                        <circle cx="18" cy="18" r="14" fill="none" stroke="currentColor" strokeWidth="3" strokeDasharray="0 100" strokeLinecap="round" className="text-primary" />
                      </svg>
                      <span className="absolute inset-0 flex items-center justify-center text-xs font-bold text-white">0%</span>
                    </div>
                    <span className="text-white/60 text-sm">0 of {course.lessons?.length || 0} completed</span>
                  </div>
                </div>
              </Link>
            ))}
